...
export const validationSchema = Joi.object({
  ...
  APP_NAME: Joi.string().default('admin'),
  ...
  DB_PASSWORD: Joi.string().allow('').default('admin'),
  MARIADB_ROOT_PASSWORD: Joi.string().allow(''),
  DB_DATABASE: Joi.string().default('admin'),
